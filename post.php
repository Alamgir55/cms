...
<?php 
    ...
    if(isset($_POST['unliked'])){
        ...
        $post = mysqli_fetch_array($postResult);
        $likes = $post['likes'];
//"DELETE FROM likes WHERE postID = $thePostID AND userID = $theUserID");
        ...
        ?>
         ...
         <?php
            ...
            <p class="pull-right"><a class="<?php echo userLikedThisPost($the_post_id) ? 'unlike' : 'like'; ?>" href="" 
                ...
                ><span class="glyphicon glyphicon-thumbs-up"></span><?php echo userLikedThisPost($the_post_id) ? ' Unlike' : ' Like'; ?></a></p>
        </div>
...
<?php 
    ...
    if(isset($_POST['create_comment'])) {
        ...
        if (!empty($comment_author) && !empty($comment_email) && !empty($comment_content)) {
            ...
            $query = "INSERT INTO comments (comment_post_id, comment_author, username, comment_email, comment_content, comment_status,comment_date)";
            $query .= "VALUES ($the_post_id ,'{$comment_author}','{$username}', '{$comment_email}', '{$comment_content }', 'unapproved',now())";
