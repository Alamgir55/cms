    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <hr>
                 <div class="row">
                     <p class="pull-right"><a class="<?php echo userLikedThisPost($the_post_id) ? 'unlike' : 'like';?>" href="#"><i class="glyphicon glyphicon-thumbs-up"></i><?php echo userLikedThisPost($the_post_id) ? 'Unlike' : 'like';?></a></p>
                 </div>
